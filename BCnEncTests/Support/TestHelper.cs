...
public static class TestHelper
{
	...
	{
		ExecuteDdsWritingTest([image], format, outputFile);
	}
	...
	public static void ExecuteEncodingTest(Image<Rgba32> image, CompressionFormat format, CompressionQuality quality,
		string filename, ITestOutputHelper output)
	{
		var encoder = new BcEncoder
		{
			OutputOptions =
	...
	public static void ExecuteHdrEncodingTest(HdrImage image, CompressionFormat format, CompressionQuality quality,
		string filename, ITestOutputHelper output)
	{
		var encoder = new BcEncoder
		{
	...
	{
		var pixels = new ColorRgba32[original.Width * original.Height];
	...
	{
		var pixels = new T[original.Width * original.Height];
		for (var y = 0; y < original.Height; y++)
		{
			for (var x = 0; x < original.Width; x++)
			{
