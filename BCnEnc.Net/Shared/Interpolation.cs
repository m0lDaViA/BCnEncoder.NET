...
internal static class Interpolation
{
	...
	/// <returns>The interpolated color.</returns>
	private static ColorRgb24 InterpolateColor(ColorRgb24 c0, ColorRgb24 c1, int num, int den) => new(
	...
	/// <param name="den">The divisor on each color component.</param>
	/// <returns>The interpolated color.</returns>
	private static ColorRgb24 InterpolateColorAtc(ColorRgb24 c0, ColorRgb24 c1, int num, int den) => new(
