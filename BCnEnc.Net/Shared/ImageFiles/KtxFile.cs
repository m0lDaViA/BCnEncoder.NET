...
public class KtxFile
{
	...
	/// 
	/// </summary>
	public List<KtxKeyValuePair> KeyValuePairs { get; } = [];
	/// <summary>
	/// 
	/// </summary>
	public List<KtxMipmap> MipMaps { get; } = [];
	...
	public void Write(Stream s)
	{
		...
		for (var mip = 0; mip < header.NumberOfMipmapLevels; mip++)
		{
			...
			bw.Write(imageSize);
			var isCubemap = header is { NumberOfFaces: 6, NumberOfArrayElements: 0 };
	...
	public static KtxFile Load(Stream s)
	{
		...
		for (uint mipLevel = 0; mipLevel < header.NumberOfMipmapLevels; mipLevel++)
		{
			...
			var cubemap = header is { NumberOfFaces: > 1, NumberOfArrayElements: 0 };
...
public class KtxKeyValuePair(string key, byte[] value)
{
	/// <summary>
	/// 
	/// </summary>
...
public unsafe struct KtxHeader
{
	...
	/// <param name="baseInternalFormat"></param>
	/// <returns></returns>
	...
	/// <param name="glTypeSize"></param>
	/// <param name="internalFormat"></param>
	/// <param name="baseInternalFormat"></param>
	/// <returns></returns>
	public static KtxHeader InitializeUncompressed(int width, int height, GlType type, GlFormat format, uint glTypeSize,
		GlInternalFormat internalFormat, GlFormat baseInternalFormat)
	{
		var header = new KtxHeader();
		Span<byte> id = [0xAB, 0x4B, 0x54, 0x58, 0x20, 0x31, 0x31, 0xBB, 0x0D, 0x0A, 0x1A, 0x0A];
		for (var i = 0; i < id.Length; i++)
...
/// 
/// </summary>
public class KtxMipFace(byte[] data, uint width, uint height)
{
	/// <summary>
	/// 
	/// </summary>
...
/// 
/// </summary>
public class KtxMipmap(uint sizeInBytes, uint width, uint height, uint numberOfFaces)
{
	/// <summary>
	/// 
	/// </summary>
	...
	/// 
	/// </summary>
	public uint Width { get; } = Math.Max(1, width);
	/// <summary>
	/// 
	/// </summary>
	public uint Height { get; } = Math.Max(1, height);
	/// <summary>
	/// 
	/// </summary>
	public uint NumberOfFaces { get; } = numberOfFaces;
	/// <summary>
	/// 
	/// </summary>
	public KtxMipFace[] Faces { get; } = new KtxMipFace[numberOfFaces];
}
