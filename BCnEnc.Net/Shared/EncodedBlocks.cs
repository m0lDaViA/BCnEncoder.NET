...
internal struct Bc1Block
{
	...
	public readonly RawBlock4X4Rgba32 Decode(bool useAlpha)
	{
		...
		var colorRgb24 = color0.ToColorRgb24();
		var rgb24 = color1.ToColorRgb24();
		...
		[
			colorRgb24,
				rgb24,
				colorRgb24.InterpolateHalf(rgb24),
				new ColorRgb24(0, 0, 0)
		]
		: stackalloc ColorRgb24[] {
				colorRgb24,
				rgb24,
				colorRgb24.InterpolateThird(rgb24, 1),
				colorRgb24.InterpolateThird(rgb24, 2)
			};
...
internal struct Bc3Block
{
	...
	public byte Alpha0
	{ readonly get => alphaBlock.Endpoint0;
		set => alphaBlock.Endpoint0 = value;
	}

	public byte Alpha1
	{ readonly get => alphaBlock.Endpoint1;
...
internal struct AtcBlock
{
	...
	public readonly RawBlock4X4Rgba32 Decode()
	{
		...
		var colorRgb24 = this.color0.ToColorRgb24();
		var rgb24 = this.color1.ToColorRgb24();

		Span<ColorRgb24> colors = [
			new ColorRgb24(0, 0, 0),
			colorRgb24.InterpolateFourthAtc(rgb24, 1),
			colorRgb24,
			rgb24
		];
		...
		for (var i = 0; i < pixels.Length; i++)
		{
			...
			var color = color0.Mode == 0 ? colorRgb24.InterpolateThird(rgb24, colorIndex) : colors[colorIndex];
