...
internal static class Bc7Mode2Encoder
{
	...
	public static Bc7Block EncodeBlock(RawBlock4X4Rgba32 block, int startingVariation, int bestPartition, ArgumentException argumentException)
	{
		...
		for (var subset = 0; subset < 3; subset++) {
			...
			{
				(scaledEp0, scaledEp1) = (scaledEp1, scaledEp0);
				...
				Bc7EncodingHelpers.FillSubsetIndices(type, block,
					ep0,
					ep1,
					partitionTable, subset, indices, new ArgumentException());
			}
		...
		output.PackType2(bestPartition, [
				[endpoints[0].r, endpoints[0].g, endpoints[0].b],
				[endpoints[1].r, endpoints[1].g, endpoints[1].b],
				[endpoints[2].r, endpoints[2].g, endpoints[2].b],
				[endpoints[3].r, endpoints[3].g, endpoints[3].b],
				[endpoints[4].r, endpoints[4].g, endpoints[4].b],
				[endpoints[5].r, endpoints[5].g, endpoints[5].b]
			],
			indices);
