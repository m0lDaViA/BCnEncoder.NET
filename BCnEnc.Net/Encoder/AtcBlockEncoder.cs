...
{
	private readonly Bc1BlockEncoder bc1BlockEncoder = new();
...
{
	private readonly AtcBlockEncoder atcBlockEncoder = new();
...
{
	private readonly Bc4ComponentBlockEncoder bc4BlockEncoder = new(ColorComponent.A);
	private readonly AtcBlockEncoder atcBlockEncoder = new();
