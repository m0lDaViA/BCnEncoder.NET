...
public static class BCnEncoderExtensions
{
	...
	public static KtxFile EncodeToKtx(this BcEncoder encoder, Image<Rgba32> inputImage) =>
		encoder.EncodeToKtx(ImageToMemory2D(inputImage));
	...
	public static DdsFile EncodeToDds(this BcEncoder encoder, Image<Rgba32> inputImage) =>
		encoder.EncodeToDds(ImageToMemory2D(inputImage));
	...
	public static byte[][] EncodeToRawBytes(this BcEncoder encoder, Image<Rgba32> inputImage) =>
		encoder.EncodeToRawBytes(ImageToMemory2D(inputImage));
	...
	public static byte[] EncodeToRawBytes(this BcEncoder encoder, Image<Rgba32> inputImage, int mipLevel,
		out int mipWidth, out int mipHeight) =>
		encoder.EncodeToRawBytes(ImageToMemory2D(inputImage), mipLevel, out mipWidth, out mipHeight);
	...
	/// <param name="outputStream">The stream to write the encoded image to.</param>
	public static void EncodeCubeMapToStream(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
	...
	/// <param name="front">The front face of the cubemap.</param>
	/// <returns>The Ktx file containing the encoded image.</returns>
	public static KtxFile EncodeCubeMapToKtx(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
		Image<Rgba32> top, Image<Rgba32> down,
		Image<Rgba32> back, Image<Rgba32> front) =>
		encoder.EncodeCubeMapToKtx(
			ImageToMemory2D(right),
			ImageToMemory2D(left),
			ImageToMemory2D(top),
			ImageToMemory2D(down),
	...
	/// <param name="front">The front face of the cubemap.</param>
	/// <returns>The Dds file containing the encoded image.</returns>
	public static DdsFile EncodeCubeMapToDds(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
		Image<Rgba32> top, Image<Rgba32> down,
		Image<Rgba32> back, Image<Rgba32> front) =>
		encoder.EncodeCubeMapToDds(
			ImageToMemory2D(right),
			ImageToMemory2D(left),
			ImageToMemory2D(top),
			ImageToMemory2D(down),
	...
	public static Task EncodeToStreamAsync(this BcEncoder encoder, Image<Rgba32> inputImage, Stream outputStream,
		CancellationToken token = default) =>
		encoder.EncodeToStreamAsync(ImageToMemory2D(inputImage), outputStream, token);
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>The Ktx file containing the encoded image.</returns>
	public static Task<KtxFile> EncodeToKtxAsync(this BcEncoder encoder, Image<Rgba32> inputImage,
		CancellationToken token = default) => encoder.EncodeToKtxAsync(ImageToMemory2D(inputImage), token);
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>The Dds file containing the encoded image.</returns>
	public static Task<DdsFile> EncodeToDdsAsync(this BcEncoder encoder, Image<Rgba32> inputImage,
		CancellationToken token = default) => encoder.EncodeToDdsAsync(ImageToMemory2D(inputImage), token);
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>A list of raw encoded data.</returns>
	public static Task<byte[][]> EncodeToRawBytesAsync(this BcEncoder encoder, Image<Rgba32> inputImage,
		CancellationToken token = default) => encoder.EncodeToRawBytesAsync(ImageToMemory2D(inputImage), token);
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>The raw encoded data.</returns>
	/// <remarks>To get the width and height of the encoded mipLevel, see <see cref="CalculateMipMapSize(BcEncoder, Image{Rgba32},int,out int,out int)"/>.</remarks>
	public static Task<byte[]> EncodeToRawBytesAsync(this BcEncoder encoder, Image<Rgba32> inputImage, int mipLevel,
		CancellationToken token = default) =>
		encoder.EncodeToRawBytesAsync(ImageToMemory2D(inputImage), mipLevel, token);
	...
	/// <param name="outputStream">The stream to write the encoded image to.</param>
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	public static Task EncodeCubeMapToStreamAsync(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
		Image<Rgba32> top, Image<Rgba32> down,
		Image<Rgba32> back, Image<Rgba32> front, Stream outputStream, CancellationToken token = default) =>
		encoder.EncodeCubeMapToStreamAsync(
			ImageToMemory2D(right),
			ImageToMemory2D(left),
			ImageToMemory2D(top),
			ImageToMemory2D(down),
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>The Ktx file containing the encoded image.</returns>
	public static Task<KtxFile> EncodeCubeMapToKtxAsync(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
		Image<Rgba32> top,
		Image<Rgba32> down, Image<Rgba32> back, Image<Rgba32> front, CancellationToken token = default) =>
		encoder.EncodeCubeMapToKtxAsync(
			ImageToMemory2D(right),
			ImageToMemory2D(left),
			ImageToMemory2D(top),
			ImageToMemory2D(down),
	...
	/// <param name="token">The cancellation token for this operation. Can be default, if the operation is not asynchronous.</param>
	/// <returns>The Dds file containing the encoded image.</returns>
	public static Task<DdsFile> EncodeCubeMapToDdsAsync(this BcEncoder encoder, Image<Rgba32> right, Image<Rgba32> left,
		Image<Rgba32> top,
		Image<Rgba32> down, Image<Rgba32> back, Image<Rgba32> front, CancellationToken token = default) =>
		encoder.EncodeCubeMapToDdsAsync(
			ImageToMemory2D(right),
			ImageToMemory2D(left),
			ImageToMemory2D(top),
			ImageToMemory2D(down),
	...
	public static int CalculateNumberOfMipLevels(this BcEncoder encoder, Image<Rgba32> inputImage) =>
		encoder.CalculateNumberOfMipLevels(inputImage.Width, inputImage.Height);
	...
	public static void CalculateMipMapSize(this BcEncoder encoder, Image<Rgba32> inputImage, int mipLevel,
		out int mipWidth, out int mipHeight)
	{
