...
public static class BCnDecoderExtensions
{
	...
	public static Image<Rgba32> DecodeRawToImageRgba32(this BcDecoder decoder, Stream inputStream, int pixelWidth,
		int pixelHeight, CompressionFormat format) =>
		ColorMemoryToImage(decoder.DecodeRaw2D(inputStream, pixelWidth, pixelHeight, format));
	...
	/// <param name="format">The format the encoded data is in.</param>
	/// <returns>The decoded Rgba32 image.</returns>
	public static Image<Rgba32> DecodeRawToImageRgba32(this BcDecoder decoder, byte[] input, int pixelWidth,
		int pixelHeight, CompressionFormat format) =>
		ColorMemoryToImage(decoder.DecodeRaw2D(input, pixelWidth, pixelHeight, format));
	...
	public static Image<Rgba32> DecodeToImageRgba32(this BcDecoder decoder, Stream inputStream) =>
		ColorMemoryToImage(decoder.Decode2D(inputStream));
	...
	public static Image<Rgba32> DecodeToImageRgba32(this BcDecoder decoder, KtxFile file) =>
		ColorMemoryToImage(decoder.Decode2D(file));
	...
	/// <returns>The decoded Rgba32 image.</returns>
	public static async Task<Image<Rgba32>> DecodeRawToImageRgba32Async(this BcDecoder decoder, Stream inputStream,
		int pixelWidth, int pixelHeight, CompressionFormat format, CancellationToken token = default) =>
		ColorMemoryToImage(await decoder.DecodeRaw2DAsync(inputStream, pixelWidth, pixelHeight, format, token));
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>The decoded Rgba32 image.</returns>
	public static async Task<Image<Rgba32>> DecodeRawToImageRgba32Async(this BcDecoder decoder, byte[] input,
		int pixelWidth, int pixelHeight, CompressionFormat format, CancellationToken token = default) =>
		ColorMemoryToImage(await decoder.DecodeRaw2DAsync(input, pixelWidth, pixelHeight, format, token));
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>The decoded Rgba32 image.</returns>
	public static async Task<Image<Rgba32>> DecodeToImageRgba32Async(this BcDecoder decoder, Stream inputStream,
		CancellationToken token = default) => ColorMemoryToImage(await decoder.Decode2DAsync(inputStream, token));
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>An array of decoded Rgba32 images.</returns>
	public static async Task<Image<Rgba32>[]> DecodeAllMipMapsToImageRgba32Async(this BcDecoder decoder,
		Stream inputStream, CancellationToken token = default)
	{
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>The decoded Rgba32 image.</returns>
	public static async Task<Image<Rgba32>> DecodeToImageRgba32Async(this BcDecoder decoder, KtxFile file,
		CancellationToken token = default) => ColorMemoryToImage(await decoder.Decode2DAsync(file, token));
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>An array of decoded Rgba32 images.</returns>
	public static async Task<Image<Rgba32>[]> DecodeAllMipMapsToImageRgba32Async(this BcDecoder decoder, KtxFile file,
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>The decoded Rgba32 image.</returns>
	public static async Task<Image<Rgba32>> DecodeToImageRgba32Async(this BcDecoder decoder, DdsFile file,
		CancellationToken token = default) => ColorMemoryToImage(await decoder.Decode2DAsync(file, token));
	...
	/// <param name="token">The cancellation token for this asynchronous operation.</param>
	/// <returns>An array of decoded Rgba32 images.</returns>
	public static async Task<Image<Rgba32>[]> DecodeAllMipMapsToImageRgba32Async(this BcDecoder decoder, DdsFile file,
		CancellationToken token = default)
	{
		var decoded = await decoder.DecodeAllMipMaps2DAsync(file, token);
		var output = new Image<Rgba32>[decoded.Length];
